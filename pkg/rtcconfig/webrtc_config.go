...
func NewWebRTCConfig(rtcConf *RTCConfig, development bool) (*WebRTCConfig, error) {
	...
	if rtcConf.NodeIP != "" && (useExternalIP || !rtcConf.NodeIPAutoGenerated) {
		if useExternalIP {
	...
	if rtcConf.UseICELite {
		s.SetLite(true)
	} else if (rtcConf.NodeIP == "" || rtcConf.NodeIPAutoGenerated) && !rtcConf.UseExternalIP && !rtcConf.UseNodeIPAsExternalIP {
